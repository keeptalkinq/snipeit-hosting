            ...
            <footer class="main-footer hidden-print" style="display:grid;flex-direction:column;">
                ...
                <div class="1hidden-xs pull-left">
                    ...
                    @if ($snipeSettings->support_footer!='off')
                        @if (($snipeSettings->support_footer=='on') || (($snipeSettings->support_footer=='admin') && (Auth::user()->isSuperUser()=='1')))
                            <a target="_blank" class="btn btn-default btn-xs"
                               href="https://ziylan.com.tr"
                               rel="noopener">{{ trans('general.user_manual') }}</a>
                            <a target="_blank" class="btn btn-default btn-xs" href="https://www.ziylan.com.tr/"
                    ...
                    @if ($snipeSettings->footer_text!='')
                        <div class="pull-left">
                           <div class="pull-left">
    BT Envanter Takip Sistemi © 2025 - Created by Mehmet EROL
</div>
                        </div>
                    @endif
                </div>
